 ...
 */
package app.crossword.yourealwaysbe.web.server.model;
 ...
 */
@Entity
@NamedQueries({@NamedQuery(name = "SavedPuzzle.findUserUriAndListingIds", query = "SELECT sp FROM app.crossword.yourealwaysbe.web.server.model.SavedPuzzle sp " +
    "WHERE sp.userUri = :userUri and sp.listingId IN (:listingIds) ORDER BY sp.listingId")
    , @NamedQuery(name = "SavedPuzzle.findUserUriAndListingId", query = "SELECT sp FROM app.crossword.yourealwaysbe.web.server.model.SavedPuzzle sp " +
    "WHERE sp.userUri = :userUri and sp.listingId = :listingId")
    , @NamedQuery(name = "SavedPuzzle.findUserUriAndListingIdAfterDate", query = "SELECT sp FROM app.crossword.yourealwaysbe.web.server.model.SavedPuzzle sp " +
