 ...
 */
package app.crossword.yourealwaysbe.web.gadget;
 ...
 * @author kebernet
 */
@ModulePrefs(title = "Forkyz", author = "Robert Cooper", author_quote = "If you only have two ducks, they are always in a row.", author_email = "kebernet@gmail.com", width = 450, height = 500, scrolling = true)
public class ForkyzGadget extends Gadget<UserPreferences>
    ...
    var response = function(obj) { 
        @app.crossword.yourealwaysbe.web.gadget.ForkyzGadget::onSuccessInternal(Lapp.crossword.yourealwaysbe/web/client/GadgetResponse;Lcom/google/gwt/http/client/RequestCallback;)(obj, callback);
    };
    var params = {};
