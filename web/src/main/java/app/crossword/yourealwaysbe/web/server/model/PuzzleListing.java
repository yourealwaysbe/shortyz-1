 ...
 */
@Entity
@NamedQueries({@NamedQuery(name = "PuzzleListing.findByDateAndSource", query = "SELECT pl FROM app.crossword.yourealwaysbe.web.server.model.PuzzleListing pl " +
    "WHERE pl.pubDate = :pubDate AND pl.source = :source")
    , @NamedQuery(name = "PuzzleListing.findAfterDate", query = "SELECT pl FROM app.crossword.yourealwaysbe.web.server.model.PuzzleListing pl " +
...
public class PuzzleListing implements Serializable {
    ...
    public String toString() {
        return "app.crossword.yourealwaysbe.web.server.model.PuzzleListing[id=" + id +
        "]";
    }
}
