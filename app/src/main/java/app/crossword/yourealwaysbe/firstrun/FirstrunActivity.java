package app.crossword.yourealwaysbe.firstrun;
...
import app.crossword.yourealwaysbe.GameHelper;
...
public class FirstrunActivity extends AppIntro implements GameHelper.GameHelperListener {
    ...
    public void onSkipPressed() {
        ((ForkyzApplication) getApplication()).getSettings().edit().putBoolean("didFirstRun", true).apply();
